...
- The library has no custom permissions. It uses Django's four default permissions per model. See the [permission system](/en/admin/permissions) page.
...
- See [Operating LCOJ](/en/operate/operations) for backups.
