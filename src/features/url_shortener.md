...
Xem thêm về cơ chế quyền tại [Hệ thống phân quyền](/site/permission_system).
...
- LCOJ đã chạy ổn định trên tên miền chính (xem [Cài đặt website](/site/installation)).
...
Xem thêm lệnh vận hành tại [Vận hành hệ thống](/site/operations).

---

## Tiếp theo

- [Hệ thống phân quyền](/site/permission_system): các quyền khác trong LCOJ và cách tổ chức nhóm.
- [Vận hành hệ thống](/site/operations): restart service, xem log, kiểm tra trạng thái.
- [Cài đặt website](/site/installation): cài đặt lại hoặc dựng môi trường thử nghiệm để kiểm tra tên miền rút gọn trước khi áp dụng cho production.
