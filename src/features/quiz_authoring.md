...
- [ ] Bạn đã đọc [Làm bài trắc nghiệm](/features/quiz) để biết học sinh sẽ thấy gì.
...
Xem thêm: [Hệ thống phân quyền](/site/permission_system).
...
- [Làm bài trắc nghiệm](/features/quiz): trải nghiệm phía học sinh.
- [Hệ thống phân quyền](/site/permission_system): cấp quyền cho giáo viên và nhóm.
