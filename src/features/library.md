...
- Thư viện không có quyền riêng, chỉ dùng bốn quyền mặc định của Django cho mỗi model (xem [Hệ thống phân quyền](/site/permission_system)).
...
- Xem thêm [Vận hành LCOJ](/site/operations) về sao lưu.
...
- [Cài đặt LCOJ](/site/installation)
- [Vận hành LCOJ](/site/operations)
